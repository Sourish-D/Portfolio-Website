...
const Experience = () => {
    ...
    return (
        <div class={`experience standard-block ${flashing ? "flash" : ""}`}>
            <button class="experience-left" onClick={swapLeft}>←</button>
            ...
            <div class="experience-right-side">
                <p dangerouslySetInnerHTML={{ __html: experiences[index].description}} />
            </div>
            <button class="experience-right" onClick={swapRight}>→</button>
        </div>
    )
}
