        ...
        <h1>View My Certificates!</h1>
            <div class="standard-block certificates-content">
                <div class="certificates-card">
                    ...
                    <button onClick={() => changeCertificate(1)}>Web Dev - Codeyoung</button>
                    <button onClick={() => changeCertificate(2)}>UCMAS - Graduation</button>
                </div>
            <div className="certificate-display">
                <img className={`certificate-current ${nextIndex !== null ? "out-left" : ""}`} src={certificates[index]} />
                {nextIndex !== null && (<img className="certificate-next in-left" src={certificates[nextIndex]} /> )}
            </div>
            </div>
        </div>
    )
