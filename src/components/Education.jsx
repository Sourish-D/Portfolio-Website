  ...
  return (
    <div class="education standard-block">
        ...
        <div class="education-course-info">
            <h2>Courses</h2>
            <p><span>Functions:</span>&nbsp;<b>96%</b></p>
            <div class="education-course-info-bar"><div style={{width:'96%'}}/></div>
            <p><span>Physics:</span>&nbsp; <b>94%</b></p>
            <div class="education-course-info-bar"><div style={{width:'94%'}}/></div>
            <p><span>Chemistry:</span>&nbsp; <b>96%</b></p>
            <div class="education-course-info-bar"><div style={{width:'96%'}}/></div>
            <p><span>English:</span>&nbsp; <b>90%</b></p>
            <div class="education-course-info-bar"><div style={{width:'90%'}}/></div>
        </div>
